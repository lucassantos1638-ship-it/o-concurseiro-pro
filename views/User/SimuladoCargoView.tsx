      ...
      <div className="max-w-5xl mx-auto">
             ...
             {cargo.materiasConfig.map(config => {
               ...
               return (
                 <button 
                  ...
                  className={`group relative flex items-center justify-between p-5 rounded-[20px] border transition-all text-left min-h-[80px] ${
                    isSelected 
                 ...
                 >
                    <div className="flex items-center gap-5 flex-1">
                       <div className={`h-11 w-11 rounded-xl flex items-center justify-center font-black text-xs border transition-colors shrink-0 ${
                         isSelected ? 'bg-primary text-white border-primary' : 'bg-slate-50 border-slate-100 text-primary'
                       }`}>
        ...
        <div className="fixed bottom-0 left-0 right-0 md:left-64 p-8 bg-transparent pointer-events-none z-40 flex justify-center">
           <button 
             ...
             onClick={() => selectedMateriaId && onStart(selectedMateriaId)}
             className={`pointer-events-auto w-full max-w-[300px] py-4 rounded-full font-black uppercase text-[11px] tracking-[0.2em] shadow-[0_20px_50px_rgba(19,91,236,0.3)] transition-all flex items-center justify-center gap-3 ${
               selectedMateriaId 
