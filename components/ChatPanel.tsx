...
const ChatPanel: React.FC<ChatPanelProps> = ({ state, onClose, setActiveTab, onUnreadMessage }) => {
  ...
  return (
    <div className="fixed inset-x-4 bottom-24 z-[60] flex flex-col bg-white sm:inset-auto sm:bottom-24 sm:right-6 h-[65vh] max-h-[550px] sm:h-[580px] w-auto sm:w-[370px] rounded-[32px] border border-slate-200 shadow-2xl animate-in slide-in-from-bottom-5 fade-in duration-300 overflow-hidden">
